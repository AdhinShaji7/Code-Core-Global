      ...
      <div className="flex flex-col justify-center sm:flex-row gap-10 my-10 mb-28">
        ...
        <div className="flex flex-col justify-center items-start gap-4">
          ...
          <p className="text-gray-500">
            Sulthan Bathery,Wayand
            <br />
            Kerala,India
          </p>

          <p className="text-gray-800">
            Tel: <span className="text-gray-500">+91 6245783215 </span>
          </p>
          <p className=" text-gray-800">
            Email: <span className="text-gray-500">admin@trendo.com</span>
          </p>

          <p className="text-gray-500">Careers at trendo</p>
          <p className="text-gray-500">
